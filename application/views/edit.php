...
<span style="cursor:pointer;" onclick="javascript:deleteimage(<?php echo $data['id'] ?>,'<?php echo $data['image']; ?>')">X</span>
</td>
</tr>
<?php }endif; ?>
<tr>
...
function deleteimage(image_id,img_name)
{
...
if (answer)
{
        $.ajax({
                ...
                data: "image_id="+image_id+"&img_name="+img_name,
